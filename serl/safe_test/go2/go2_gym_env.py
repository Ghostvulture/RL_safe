...
class Go2GymEnv(MujocoGymEnv):
    ...
    def __init__(
        ...
        self.render_width = render_spec.width if render_spec.width is not None else 640
        self.render_height = render_spec.height if render_spec.height is not None else 480
